...
> {
  ...
  async changeAdmin(
    ...
    const message = this._seaPadNftPoolInput.changeAdmin(
      args,
      optionTx,
      gasBudget,
      packageObjectId,
  ...
  async createPool(
    ...
    const message = this._seaPadNftPoolInput.createPool(
      types,
      args,
      optionTx,
      gasBudget,
  ...
  async addCollection(
    ...
    const message = this._seaPadNftPoolInput.addCollection(
      types,
      args,
      optionTx,
      gasBudget,
  ...
  async startPool(
    ...
    const message = this._seaPadNftPoolInput.startPool(
      types,
      args,
      optionTx,
      gasBudget,
  ...
  async buyNft(
    ...
    const message = this._seaPadNftPoolInput.buyNft(
      types,
  ...
  async stopPool(
    ...
    const message = this._seaPadNftPoolInput.stopPool(
      types,
      args,
      optionTx,
      gasBudget,
  ...
  async claimNft(
    ...
    const message = this._seaPadNftPoolInput.claimNft(
      types,
      args,
      optionTx,
      gasBudget,
  ...
  async claimRefund(
    ...
    const message = this._seaPadNftPoolInput.claimRefund(
      types,
      args,
      optionTx,
      gasBudget,
  ...
  async addWhitelist(
    ...
    const message = this._seaPadNftPoolInput.addWhitelist(
      types,
      args,
      optionTx,
      gasBudget,
  ...
  async removeWhitelist(
    ...
    const message = this._seaPadNftPoolInput.removeWhitelist(
      types,
      args,
      optionTx,
      gasBudget,
  ...
  async withdrawFund(
    ...
    const message = this._seaPadNftPoolInput.withdrawFund(
      types,
      args,
      optionTx,
      gasBudget,
  ...
  async changeTreasuryAdmin(
    ...
    const message = this._seaPadNftPoolInput.changeTreasuryAdmin(
      types,
      args,
      optionTx,
      gasBudget,
