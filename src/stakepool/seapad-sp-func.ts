...
export abstract class SeaPadStakePoolFunc<T> {
    ...
    abstract registerPool(
        ...
        args: { rewards: string, duration: string, global_config: string, decimalS: number, decimalR: number },
        optionTx?: OptionTx,
        gasBudget?: GasBudget,
    ): T;
    /**
    ...
    abstract unstake(
        types: { S: string; R: string },
        args: {
            pool: string, stake_amount: string, global_config: string
        },
        optionTx?: OptionTx,
        gasBudget?: GasBudget,
    ): T;
    ...
    abstract emergencyUnstake(
        types: { S: string; R: string },
        args: {
            pool: string, amount: string, global_config: string
        },
        optionTx?: OptionTx,
        gasBudget?: GasBudget,
    ): T;
