...
export abstract class SeaPadFunc {
     ...
     */
    abstract addProject(types: { COIN: string }, args: { adminCap: string, round: number, usewhitelist: boolean, softCap: string, hardCap: string, swapRatioSui: string, swapRatioToken: string, maxAllocate: string, vestingType: number, firstVestingTime: string }, gasBudget?: GasBudget): SeaPadDataInput | Promise<SuiExecuteTransactionResponse>
    /**
     *
     * @param types <COIN>
     ...
     */
    abstract saveProfile(types: { COIN: string }, args: { adminCap: string, project: string, name: string, twitter: string, discord: string, telegram: string, website: string }, gasBudget?: GasBudget): SeaPadDataInput | Promise<SuiExecuteTransactionResponse>
    /**
     *
     * @param types <COIN>
     ...
     */
    abstract distributeRaisedFund(types: { P: string, COIN: string }, args: { adminCap: string, project: string, projectOwner: string }, gasBudget?: GasBudget): SeaPadDataInput | Promise<SuiExecuteTransactionResponse>
    /**
     *
     * @param types <COIN>
     * @param args cap: &AdminCap, project: &mut Project<COIN>, projectOwner: address,
     */
    abstract refundToken(types: { COIN: string }, args: { cap: string, project: string, projectOwner: string }, gasBudget?: GasBudget): SeaPadDataInput | Promise<SuiExecuteTransactionResponse>
    /**
     *
     * @param types <COIN>
